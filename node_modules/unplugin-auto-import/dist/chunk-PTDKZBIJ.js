...
var _chunkOY3FND6Vjs = require('./chunk-OY3FND6V.js');
...
function resolveOptions(options = {}, root = process.cwd()) {
  ...
  const resolved = _chunkOY3FND6Vjs.__spreadProps.call(void 0, _chunkOY3FND6Vjs.__spreadValues.call(void 0, {
    sourceMap: false,
    resolvedImports: {},
...
function flattenImportsMap(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkOY3FND6Vjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkOY3FND6Vjs.presets[definition];
